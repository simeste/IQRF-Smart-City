// *********************************************************************
//   Custom DPA Handler code - Trafficlight (1 shift register)		   *
// *********************************************************************
//
...
//
// BE AWARE: This is for use with one shift register.
// 			 For use with two shift registers, use:
//			 CustomDpaHandler-TrafficLight-NS-2SHR.c
//
// *********************************************************************
...
void shift(uns8 data);

int walkLeft;					// These may be bit instead of int, or at least int8 for future versions.
int walkRight;
...
DpaHandleReturnTRUE:
	...
	case DpaEvent_Reset:
		...
		// Button 2 (right)
		TRISC.2 = 1;			// PIN 2: MAIN		Register RA0 - (input)
...
{	
	uns8 i;
	uns8 mask = 1;
	uns8 mask1 = 1;					// For timing only
	uns8 data1 = 0b00000000;		// For timing only
	
	waitDelay(1);
	
	// The first FOR-loop is entirely for timing purposes only, not neccessary and can safely be removed.
